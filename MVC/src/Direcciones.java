...
public class Direcciones extends JFrame {
	...
	public Direcciones(int language) {
		...
		System.out.println("linea 30 de direcciones que nos da null"+datos);
		...
		System.out.println("linea 55 de direcciones.java valor de datos tipo Datos "+datos);
		
		tiposDireccionesDatos=datos.getTiposDirecc(); //METODO DEFINIDO EN lin18 datos.java
